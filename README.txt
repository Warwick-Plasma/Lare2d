...
"lare2d-3.0.0.tar.gz". These are tarred and gzipped packages of the code
which can be unpacked with the command "tar xzf lare2d-3.0.0.tar.gz".
This will create a directory called "lare2d-3.0.0".
...
This library used by Lare2d for reading and writing the files is automatically
...
following command:
  ...
  git clone --recursive ssh://<name>@ccpforge.cse.rl.ac.uk/gitroot/lare2d
