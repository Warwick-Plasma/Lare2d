...
OBJFILES = shared_data.o mpi_routines.o openboundary.o mpiboundary.o boundary.o diagnostics.o setup.o lagran.o  \
 remap.o xremap.o yremap.o zremap.o strings.o initial_conditions.o deck_boundaries_block.o deck_control_block.o deck.o welcome.o lare2d.o
...
.PHONEY: visit
visit:
	@cd VisIT;xml2makefile -clobber l2dv2.xml;make
...
deck.o:deck.f90 shared_data.o initial_conditions.o strings.o deck_control_block.o
welcome.o: welcome.f90 shared_data.o
lare2d.o:lare2d.f90 shared_data.o setup.o boundary.o diagnostics.o lagran.o remap.o mpi_routines.o welcome.o initial_conditions.o strings.o deck.o openboundary.o
